...
force force ace_medical_spontaneousWakeUpChance = 0.145429;
...
force force ace_medical_treatment_litterCleanupDelay = 215.017;
...
firce force ace_finger_maxRange = 5;
...
// ACE Wind Deflection
force force ce_winddeflection_enabled = true;
force force ce_winddeflection_simulationInterval = 0.05;
